...
public interface MarketService {
    ...
    ResponseEntity<String> addProduct(String username, int productId, String storeName, String productName, String productDescription,
                                             double productPrice, int productQuantity, double rating, Category category, List<String> keyWords);
    ResponseEntity<String> removeProduct        (String username, String storeName,   int productId);
    ...
    ResponseEntity<String> setRating            (String username, String storeNameId, int productId, int rating);
    ResponseEntity<String> setCategory          (String username, String storeNameId, int productId,Category category);
