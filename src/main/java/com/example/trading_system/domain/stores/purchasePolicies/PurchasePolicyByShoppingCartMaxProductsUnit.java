...
public class PurchasePolicyByShoppingCartMaxProductsUnit extends PurchasePolicy {
    ...
    public void setPurchasePolicyCategory(int categoryId) {
        throw new RuntimeException("Action not allowed for policy by shopping cart max products unit");
    }
    ...
    public String getPurchasePolicyInfo() {
        return "{ \"type\": \"Maximum product units in shopping bag Policy\", \"productId\": " + productId + ", \"units\": " + numOfQuantity + " }";
    }
}
