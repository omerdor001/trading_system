...
public class SearchAcceptanceTests {
    ...
    public void setUp() {
        ...
        marketService = new MarketService(marketFacadeMock);
    }
    ...
    public void testSearchNameInStore_Success() {
        ...
        when(marketFacadeMock.searchNameInStore(name, storeName, minPrice, maxPrice, minRating, category))
                .thenReturn(expectedResponse);

        String result = marketService.searchNameInStore(name, storeName, minPrice, maxPrice, minRating, category);

        assertEquals(expectedResponse, result);
        verify(marketFacadeMock, times(1))
                .searchNameInStore(name, storeName, minPrice, maxPrice, minRating, category);
    }
    @Test
    public void testSearchCategoryInStore_Success() {
        ...
        String expectedResponse = "mocked response";
        when(marketFacadeMock.searchCategoryInStore(category, storeName, minPrice, maxPrice, minRating))
                .thenReturn(expectedResponse);
        ...
        assertEquals(expectedResponse, result);
        verify(marketFacadeMock, times(1))
                .searchCategoryInStore(category, storeName, minPrice, maxPrice, minRating);
    }

    @Test
    public void testSearchKeywordsInStore_Success() {
        String storeName = "store1";
        String keyWords = "electronics";
        Double minPrice = 10.0;
        Double maxPrice = 50.0;
        Double minRating = 4.0;
        Category category = Category.Food;
        ...
        String expectedResponse = "mocked response";
        when(marketFacadeMock.searchKeywordsInStore(keyWords, storeName, minPrice, maxPrice, minRating, category))
                .thenReturn(expectedResponse);
        ...
        assertEquals(expectedResponse, result);
        verify(marketFacadeMock, times(1))
                .searchKeywordsInStore(keyWords, storeName, minPrice, maxPrice, minRating, category);
    }
