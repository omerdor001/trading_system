...
public class PlaceBidAcceptanceTests {
    ...
    void placeOneBid_Success() {
        ...
        Assertions.assertEquals("[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]", result2.getBody());
        Assertions.assertEquals("{\"Store1\":[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]}", tradingSystem.getMyBids(regularUserName, regularUserToken).getBody());
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
        Assertions.assertEquals("[{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner2\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}]", tradingSystem.getPendingUserNotifications(ownerUserName, ownerToken, "rowner2").getBody());
    }
    ...
    void placeTwoBids_Success() {
        ...
        Assertions.assertEquals("[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true},{\"id\":null,\"userName\":\"regularUser\",\"productID\":222,\"price\":10.0,\"productName\":\"product2\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]", tradingSystem.getStoreBids(ownerUserName, ownerToken, storeName).getBody());
        Assertions.assertEquals("{\"Store1\":[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true},{\"id\":null,\"userName\":\"regularUser\",\"productID\":222,\"price\":10.0,\"productName\":\"product2\",\"approvedBy\":[],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]}", tradingSystem.getMyBids(regularUserName, regularUserToken).getBody());
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 222 in store Store1 with price 10.0\"}"));
    }
    ...
    void approveBidOneOwner_Success() {
        ...
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
        verify(mockNotificationSender).sendNotification(eq(regularUserName), eq("{\"senderUsername\":\"owner1\",\"receiverUsername\":\"regularUser\",\"textContent\":\"Your bid on product Product1 in store Store1 is approved\"}"));
    ...
    void approveBidOneOwnerButHaveTwoOwners_Success() {
        ...
        Assertions.assertEquals("Approved bid successfully.", res.getBody());
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
        verify(mockNotificationSender).sendNotification(eq(secondOwnerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner2\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
        Assertions.assertEquals("", tradingSystem.getAllHistoryPurchases(ownerUserName, ownerToken, storeName).getBody());
        Assertions.assertEquals("{\"Store1\":[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[\"owner1\"],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]}", tradingSystem.getMyBids(regularUserName, regularUserToken).getBody());
        Assertions.assertEquals("[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":10.0,\"productName\":\"Product1\",\"approvedBy\":[\"owner1\"],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":true}]", tradingSystem.getStoreBids(ownerUserName, ownerToken, storeName).getBody());
    }
    ...
    void approveTwoOwners() {
        ...
        verify(mockNotificationSender).sendNotification(eq(regularUserName), eq("{\"senderUsername\":\"owner2\",\"receiverUsername\":\"regularUser\",\"textContent\":\"Your bid on product Product1 in store Store1 is approved\"}"));
        Assertions.assertNotEquals("",tradingSystem.getAllHistoryPurchases(ownerUserName, ownerToken, storeName).getBody());
    ...
    void testRejectBid_Success() {
        ...
        verify(mockNotificationSender).sendNotification(eq(regularUserName), eq("{\"senderUsername\":\"owner1\",\"receiverUsername\":\"regularUser\",\"textContent\":\"Your bid on product Product1 in store Store1 is rejected\"}"));
        verify(mockNotificationSender).sendNotification(eq(ownerUserName), eq("{\"senderUsername\":\"regularUser\",\"receiverUsername\":\"owner1\",\"textContent\":\"rregularUser is placed a bid for product 111 in store Store1 with price 10.0\"}"));
...
//}
    ...
    void placeCounterOffer_success() {
        ...
        Assertions.assertEquals("{\"Store1\":[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":11.0,\"productName\":\"Product1\",\"approvedBy\":[\"owner1\"],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":false}]}", tradingSystem.getMyBids(regularUserName, regularUserToken).getBody());
        Assertions.assertEquals("[{\"id\":null,\"userName\":\"regularUser\",\"productID\":111,\"price\":11.0,\"productName\":\"Product1\",\"approvedBy\":[\"owner1\"],\"allOwnersApproved\":false,\"store_name\":\"Store1\",\"address\":\"1234 Main Street, Springfield, IL, 62704-1234\",\"amount\":\"100.00\",\"currency\":\"USD\",\"cardNumber\":\"4111111111111111\",\"month\":\"12\",\"year\":\"2025\",\"holder\":\"John Doe\",\"ccv\":\"123\",\"holderId\":\"123456789\",\"customerApproved\":false}]", tradingSystem.getStoreBids(ownerUserName, ownerToken, storeName).getBody());
        verify(mockNotificationSender).sendNotification(eq(regularUserName), eq("{\"senderUsername\":\"owner1\",\"receiverUsername\":\"regularUser\",\"textContent\":\"Your bid on product Product1 in store Store1 is got counter offer by rowner1 of 11.0\"}"));
    }
